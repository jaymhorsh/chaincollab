...
//   creatorId: string;
// }
// export const createLivestream = async ({ streamName, record, creatorId }: CreateLivestreamProps) => {
//   try {
...
//   try {
//     const response = await axios.delete(`https://livepeer.studio/api/stream/${id}`, {
//       headers: {
//         Authorization: `Bearer ${process.env.STUDIO_API_KEY ?? 'none'}`,
//       },
//     });
