...
const Header: React.FC<HeaderProps> = ({ userId}) => {
  ...
  const { linkWallet, linkEmail, linkApple, linkDiscord, user,ready, linkGithub, linkGoogle, linkPhone, linkTwitter } = usePrivy();
  const linkOptions = [
    ...
    <header className="shadow-sm">
      <div className="max-w-7xl mx-auto py-4 border border-[#DFE0E1] bg-white px-4 sm:px-6 lg:px-10 flex justify-between items-center">
        ...
        <div className=" flex items-center gap-2">
          <div className="text-sm  font-semibold"><span className='text-main-blue text-base'>Wallet Address:</span> {user?.wallet?.address}</div>
