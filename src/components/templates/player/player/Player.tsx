...
//           <Player.Video title="Live stream" className="h-full w-full transition-all object-contain" />
...
//               <div className="text-sm text-gray-100">Playback will start automatically once the stream has started</div>
//             </div>
//           </Player.ErrorIndicator>
...
//               <div className="text-sm text-gray-100">It looks like you dont have permission to view this content</div>
//             </div>
//           </Player.ErrorIndicator>
//           <Player.Controls
//             autoHide={1000}
...
//   <div className="relative w-full px-3 py-2 gap-3 flex-col-reverse flex aspect-video max-w-2xl mx-auto animate-pulse bg-white/70 overflow-hidden rounded-sm">
...
export function PlayerWithControls({ src }: { src: Src[] }) {
  ...
  // Read the customization settings from localStorage when the component mounts.
  useEffect(() => {
